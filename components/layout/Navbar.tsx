    ...
    return (
        <>
            ...
            {isOpen && (
                ...
                >
                    <div
                        className="absolute inset-0 bg-heureuse-navy flex flex-col pt-24 px-6 pb-8 overflow-y-auto"
                    ...
                    >
                        <nav className="flex flex-col gap-1 mb-8">
                            {NAV_LINKS.map((link) => (
                                <Link
                                    ...
                                    href={link.href}
                                    onClick={() => setIsOpen(false)}
                                    className="text-xl md:text-2xl font-medium text-white hover:text-heureuse-gold transition-colors py-4 border-b border-white/10"
                                >
                                    {link.label}
                                </Link>
                            ))}
                        ...
                        <div className="flex flex-col gap-4 mt-auto">
                            ...
                            <Button asChild variant="outline" className="w-full h-12 text-base border-heureuse-gold text-heureuse-gold hover:bg-heureuse-gold hover:text-heureuse-navy bg-transparent">
                        ...
                        <div className="mt-6 flex justify-center text-gray-400">
                            <span className="text-xs">© {new Date().getFullYear()} Heureuse Logistics</span>
                        </div>
                    </div>
                </div>
            )}
